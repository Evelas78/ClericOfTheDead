...
{	
	struct_Textbox:
	{
		...
		struct_TextToDraw: 
		{
			...
			bool_TextPosCentered: bool_MainText_Centered,
...
specialarr_Choices = [array_ChoiceOne];
if(array_ChoiceTwo != -1)
	array_push(specialarr_Choices, array_ChoiceTwo)
if(array_ChoiceThree != -1)
	array_push(specialarr_Choices, array_ChoiceThree)
if(array_ChoiceFour != -1)
	array_push(specialarr_Choices, array_ChoiceFour)

load_default_choices(struct_DialogueBox, specialarr_Choices);
